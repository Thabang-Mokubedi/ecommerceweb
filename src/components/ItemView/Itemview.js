...
import bagIcon from "../../assets/NavLink.png";
import { Link } from "react-router-dom";
import RatingsIcon from "../../assets/Rating.png";

const Item1 = () => {
    return (
        <>
            <Link to="/" >
                <img src={bagIcon} className="Back-Btn"/>
            </Link>
            <div className="item-view">
                <div className="bottom-area">
                    <div className="item-details">
                        <img src={product1} alt="Apple Watch" className="item-image" />
                        <div className="item-info">
                            <h2 className="item-title">Apple Watch</h2>
                            <h3 className="item-subtitle">SERIES 5 SE</h3>
                            <img src={RatingsIcon} alt="5-star rating" className="star-rating" />
